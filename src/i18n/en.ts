...
export const en = {
  ...
  wfrp: {
    ...
    magic: {
      ...
      removeSpellA11y: 'Remove {name}',
      removePrayerA11y: 'Remove {name}',
    ...
    grants: {
      ...
      removeSkillA11y: 'Remove {name}',
      removeTalentA11y: 'Remove {name}',
      addSkillA11y: 'Add skill',
      addTalentA11y: 'Add talent',
    },
    combat: {
      weapons: 'Weapons',
      armour: 'Armour',
      ...
      removeWeaponA11y: 'Remove {name}',
      removeArmourA11y: 'Remove {name}',
